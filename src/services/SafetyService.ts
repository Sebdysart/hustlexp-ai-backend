...
class SafetyServiceClass {
    ...
    async moderateContent(
        ...
        userId?: string,
        taskId?: string,
        options?: { category?: string; skipAI?: boolean }
     ...
     */
    private localPatternCheck(content: string): ModerationResult {
     ...
     */
    private getLabelFromPattern(pattern: RegExp): RiskLabel {
