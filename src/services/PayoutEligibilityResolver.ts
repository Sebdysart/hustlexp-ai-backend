...
export class PayoutEligibilityResolver {
    ...
    static async resolve(
        taskId: string,
        options?: { adminOverride?: AdminOverride }
     ...
     */
    private static async logDecision(taskId: string, result: EligibilityResult): Promise<void> {
        const db = getDb();
     ...
     */
    static validateAdminOverride(override: AdminOverride): { valid: boolean; error?: string } {
        if (!override.adminId) {
