...
import { AIIdentityContextService, AIOnboardingContext, OnboardingPersonalization } from '../../services/AIIdentityContextService.js';
...
export function buildIdentityAwareSystemPrompt(ctx: AIOnboardingContext): string {
...
function getTrustTierInstructions(trustTier: AIOnboardingContext['trustTier']): string {
    switch (trustTier) {
        case 'verified':
            return `
...
function getRiskLevelInstructions(
...
function getXPMultiplierText(trustTier: AIOnboardingContext['trustTier']): string {
    switch (trustTier) {
...
export function getXPMultiplier(trustTier: AIOnboardingContext['trustTier']): number {
    switch (trustTier) {
 ...
 */
export async function enrichOnboardingConversation(
    userId: string,
 ...
 */
export function parseOnboardingActions(response: string): AIOnboardingAction[] {
    const actions: AIOnboardingAction[] = [];
