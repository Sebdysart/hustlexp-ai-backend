...
export class CompensationService {
    ...
    // Safety Thresholds
    private static MAX_AUTO_DRIFT_CENTS = 500; // $5.00 auto-fix allowed

    /**
     * PROPOSE COMPENSATION
     * Generates a transaction to fix the balance.
     */
    static async proposeCompensation(
        accountId: string,
        driftAmount: number, // Positive = Ledger has MORE than Reality (Need to Credit Asset/Debit Liab to reduce?)
        // Wait. 
    ...
    private static async getSystemDriftAccount(): Promise<string> {
