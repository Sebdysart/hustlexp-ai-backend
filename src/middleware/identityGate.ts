...
interface VerificationStatus {
    ...
    verificationStatus: 'unverified' | 'email_verified' | 'verified';
...
async function getUserVerificationStatus(userId: string): Promise<VerificationStatus | null> {
...
export async function requireOnboardingUnlocked(
    request: FastifyRequest,
    reply: FastifyReply
): Promise<void> {
    const userId = request.user?.uid;
...
export async function getIdentityContextForAI(userId: string): Promise<{
    isVerified: boolean;
