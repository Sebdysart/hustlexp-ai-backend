 ...
 * - GET /health/detailed - Extended health with database replica status
 * - GET /health/live - Liveness probe (k8s)
 * - GET /health/ready - Readiness probe (k8s)
 * - GET /metrics - Prometheus metrics
 *
 * @version 1.1.0 (BUILD_GUIDE aligned)
 */
