 ...
 */
export async function handlePayoutCompletion(taskId, hustlerId) {
    const errors = [];
 ...
 */
export async function verifyXPAwarded(taskId) {
    const sql = getSql();
...
//# sourceMappingURL=PayoutCompletionHandler.js.map