...
export class BetaMetricsService {
    ...
    static killswitchActivated(reason) {
    ...
    // INTERNAL HELPERS
    // -----------------------------------------------------------
    static recordEvent(type, metadata) {
    ...
    static getRecentEvents(windowMs) {
...
//# sourceMappingURL=BetaMetricsService.js.map