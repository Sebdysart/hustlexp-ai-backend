 ...
 */
import { PayoutDecision, BlockReason } from './PayoutEligibilityResolver.js';
import { ProofState } from './proof/types.js';
// ============================================================
// USER-FACING STATES (What the UI shows)
// ============================================================
export var UserPayoutState;
(function (UserPayoutState) {
    UserPayoutState["READY"] = "ready";
    UserPayoutState["AWAITING_PROOF"] = "awaiting_proof";
    UserPayoutState["PROOF_REVIEWING"] = "proof_reviewing";
    UserPayoutState["PROOF_ISSUE"] = "proof_issue";
    UserPayoutState["DISPUTE_PENDING"] = "dispute_pending";
    UserPayoutState["UNDER_REVIEW"] = "under_review";
    UserPayoutState["COMPLETED"] = "completed";
    UserPayoutState["BLOCKED"] = "blocked";
})(UserPayoutState || (UserPayoutState = {}));
// ============================================================
// EXPLAINER SERVICE
// ============================================================
export class PayoutExplainer {
     ...
     */
    static explainBlock(result, amount) {
     ...
     */
    static explainEscalation(result, amount) {
     ...
     */
    static explainProofState(proofState) {
        switch (proofState) {
...
//# sourceMappingURL=PayoutExplainer.js.map