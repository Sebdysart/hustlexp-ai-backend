...
import { PRICING_CLASSIFIER_SYSTEM, SCAM_CLASSIFIER_SYSTEM, buildPricingClassifierPrompt, buildScamClassifierPrompt, } from '../ai/prompts/tpee-classifiers.js';
...
class TPEEAIEscalationClass {
    ...
    pricingClassifierEnabled = true;
    scamClassifierEnabled = true;
    escalationEnabled = true; // Master switch
    // ============================================
    // Main Escalation Entry Point
    // ============================================
    async escalate(tpeeResult, input, medianPrice, medianDurationMinutes, medianSource = 'PRE_AI') {
        const noEscalation = {
            should_adjust: false,
            should_review: false,
        ...
        if (tpeeResult.decision !== 'ACCEPT') {
            serviceLogger.debug({ decision: tpeeResult.decision }, 'AI escalation skipped - deterministic decision is not ACCEPT');
            return noEscalation;
        }
        // Master kill switch
    ...
    // Pricing Classifier
    // ============================================
    async classifyPricingRealism(input, tpeeEvalId) {
    ...
    // Scam Classifier
    // ============================================
    async classifySubtleScam(input, tpeeEvalId) {
    ...
    // ============================================
    async logAICall(tpeeEvalId, classifier, rawOutput, success, failureReason, confidence) {
...
//# sourceMappingURL=TPEEAIEscalation.js.map