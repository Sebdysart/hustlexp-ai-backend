...
export class LedgerLockService {
     ...
     */
    static async acquire(resourceId, txId, ttlSeconds = 30) {
     ...
     * All or Nothing.
     */
    static async acquireBatch(resources, txId, ttlSeconds = 30) {
     ...
     */
    static async release(resourceId, txId) {
        await query(`
...
//# sourceMappingURL=LedgerLockService.js.map