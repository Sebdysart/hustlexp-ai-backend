...
async function check() {
    ...
    try {
        const stripe = new Stripe(key, { apiVersion: '2024-11-20.acacia' }); // Using a generally compatible version for check
...
check();
//# sourceMappingURL=stripe-capability-check.js.map