        ...
        for (const tr of transfers.data) {
            await sql `
                INSERT INTO stripe_transfer_history (
                    ...
                    ${tr.id}, ${tr.amount}, ${tr.currency}, ${tr.destination}, 
        ...
        for (const po of payouts.data) {
            await sql `
                INSERT INTO stripe_payout_history (
                    ...
                    ${new Date(po.arrival_date * 1000)}, ${new Date(po.created * 1000)}, ${po.destination}
                )
...
//# sourceMappingURL=reconcile_stripe_ledger.js.map