...
async function createTestTask(posterId, hustlerId) {
    const id = crypto.randomUUID();
    await sql `
...
async function test1_hashReuse() {
...
async function test2_aiGenerated() {
...
async function test3_stallTactic() {
    const posterId = await createTestUser();
    const hustlerId = await createTestUser();
...
async function test4_disconnectMidAnalysis() {
    const posterId = await createTestUser();
    const hustlerId = await createTestUser();
    const taskId = await createTestTask(posterId, hustlerId);
...
async function test5_adminAudit() {
    const posterId = await createTestUser();
    const hustlerId = await createTestUser();
...
//# sourceMappingURL=abuse-simulation.js.map