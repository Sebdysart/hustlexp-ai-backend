...
const REQUIRED_MIGRATION_FILES = [
  ...
  {
    name: TASK_OUTCOME_CLASSIFICATION_MIGRATION,
  ...
  {
    name: CHARGEBACK_LIFECYCLE_MIGRATION,
    fileName: 'chargeback_lifecycle.sql',
  },
  {
  ...
  {
    name: TASK_SCOPE_VERSIONS_MIGRATION,
    fileName: '20260718_task_scope_versions.sql',
  },
  {
    name: TASK_LOCATION_ENCRYPTION_MIGRATION,
    fileName: '20260718_task_location_encryption.sql',
  },
  {
    name: PROOF_SUBMISSION_ATOMICITY_MIGRATION,
    fileName: '20260718_proof_submission_atomicity.sql',
  },
  {
    name: TASK_SAFETY_INCIDENT_CASES_MIGRATION,
    fileName: '20260718_task_safety_incident_cases.sql',
  },
  {
    name: TASK_SAFETY_DELIVERY_CONTRACT_MIGRATION,
    fileName: '20260718_task_safety_delivery_contract.sql',
  },
  {
    name: TASK_SAFETY_CHECKINS_MIGRATION,
    fileName: '20260718_task_safety_checkins.sql',
  },
  {
    name: TASK_SAFETY_LOCATION_ENCRYPTION_MIGRATION,
    fileName: '20260718_task_safety_location_encryption.sql',
  },
  {
    name: ZONE_CATEGORY_LIQUIDITY_CELLS_MIGRATION,
    fileName: '20260718_zone_category_liquidity_cells.sql',
  },
  {
    name: WORKER_OFFER_DECISION_CONTRACT_MIGRATION,
    fileName: '20260718_worker_offer_decision_contract.sql',
  },
  {
    name: WORKER_SCREENING_RIGHTS_CONTRACT_MIGRATION,
    fileName: '20260718_worker_screening_rights_contract.sql',
  },
  {
    name: REGION_POLICY_CONTRACT_MIGRATION,
    fileName: '20260718_region_policy_contract.sql',
  },
  {
    name: COMPLETION_RETENTION_CONTRACT_MIGRATION,
    fileName: '20260718_completion_retention_contract.sql',
  },
  {
    name: TASK_PUBLIC_CLARIFICATIONS_MIGRATION,
    fileName: '20260718_task_public_clarifications.sql',
  },
  {
    name: MARKETPLACE_REPUTATION_CONTRACT_MIGRATION,
    fileName: '20260718_marketplace_reputation_contract.sql',
  },
  {
    name: BUSINESS_WORKSPACE_CONTRACT_MIGRATION,
    fileName: '20260718_business_workspace_contract.sql',
  },
  {
    name: BUSINESS_OPERATIONS_CONTRACT_MIGRATION,
    fileName: '20260718_business_operations_contract.sql',
  },
  {
    name: BUSINESS_EXECUTION_CONTRACT_MIGRATION,
    fileName: '20260718_business_execution_contract.sql',
  },
  {
    name: RECURRING_WORK_CONTRACT_MIGRATION,
    fileName: '20260718_recurring_work_contract.sql',
  },
  {
    name: BUSINESS_RECURRING_CONTRACT_MIGRATION,
    fileName: '20260718_business_recurring_contract.sql',
  },
  {
    name: RECOMMENDATION_CONTRACT_MIGRATION,
    fileName: '20260719_recommendation_contract.sql',
  },
  {
    name: HUSTLER_WALLET_CONTRACT_MIGRATION,
    fileName: '20260719_hustler_wallet_contract.sql',
  },
  {
    name: WALLET_PROVIDER_EVENT_INTEGRITY_MIGRATION,
    fileName: '20260719_wallet_provider_event_integrity.sql',
  },
  {
    name: WALLET_PROVIDER_EVENT_INTEGRITY_REPAIR_MIGRATION,
    fileName: '20260719_wallet_provider_event_integrity_repair.sql',
  },
  {
    name: LIFECYCLE_SERVICE_FOUNDATIONS_MIGRATION,
    fileName: '20260719_lifecycle_service_foundations.sql',
  },
  {
    name: TASK_WORKER_ELIGIBILITY_CONTRACT_MIGRATION,
    fileName: '20260719_task_worker_eligibility_contract.sql',
  },
  {
    name: APPEND_ONLY_TRUNCATE_CONTRACT_MIGRATION,
    fileName: '20260719_append_only_truncate_contract.sql',
  },
  {
    name: ADMIN_USER_SEARCH_TRIGRAM_CONTRACT_MIGRATION,
    fileName: '20260719_admin_user_search_trigram_contract.sql',
  },
  {
    name: ADMIN_CAPABILITY_CONTRACT_MIGRATION,
    fileName: '20260719_admin_capability_contract.sql',
  },
  {
    name: TIER0_BROWSE_ONLY_CONTRACT_MIGRATION,
    fileName: '20260719_tier0_browse_only_contract.sql',
  },
  {
    name: TASK_TEMPLATE_POLICY_CONTRACT_MIGRATION,
    fileName: '20260719_task_template_policy_contract.sql',
  },
  {
    name: COMPLIANCE_GUARDIAN_PERSISTENCE_CONTRACT_MIGRATION,
    fileName: '20260719_compliance_guardian_persistence_contract.sql',
  },
  {
    name: WORKER_OFFER_RETAKE_CONTRACT_MIGRATION,
    fileName: '20260719_worker_offer_retake_contract.sql',
  },
  {
    name: LIQUIDITY_EXPANSION_CONTRACT_MIGRATION,
    fileName: '20260719_liquidity_expansion_contract.sql',
  },
  {
    name: LIQUIDITY_EXPANSION_FK_REPAIR_MIGRATION,
    fileName: '20260719_liquidity_expansion_fk_repair.sql',
  },
  {
    name: WORKER_COUNTER_OFFER_CONTRACT_MIGRATION,
    fileName: '20260719_worker_counter_offer_contract.sql',
  },
  {
    name: WORKER_COUNTER_OFFER_EXCLUSIVITY_MIGRATION,
    fileName: '20260719_worker_counter_offer_exclusivity.sql',
  },
  {
    name: EXTERNAL_TASK_BRIDGE_CONTRACT_MIGRATION,
    fileName: '20260719_external_task_bridge_contract.sql',
  },
  {
    name: TASK_GEOFENCE_EVENT_CONTRACT_MIGRATION,
    fileName: '20260720_task_geofence_event_contract.sql',
  },
  {
    name: MAJOR_ACTION_TELEMETRY_CONTRACT_MIGRATION,
    fileName: '20260720_major_action_telemetry_contract.sql',
  },
  {
    name: MAJOR_ACTION_TELEMETRY_CONTRACT_REPAIR_MIGRATION,
    fileName: '20260720_major_action_telemetry_contract_repair.sql',
  },
  {
    name: MAJOR_ACTION_SOURCE_REGISTRY_REPAIR_MIGRATION,
    fileName: '20260720_major_action_source_registry_repair.sql',
  },
  {
    name: OFFLINE_ACTION_SYNC_CONTRACT_MIGRATION,
    fileName: '20260720_offline_action_sync_contract.sql',
  },
  {
    name: OFFLINE_ACTION_SYNC_CONTRACT_REPAIR_MIGRATION,
    fileName: '20260720_offline_action_sync_contract_repair.sql',
  },
  {
    name: PROOF_VERIFICATION_SIGNAL_CONTRACT_MIGRATION,
    fileName: '20260720_proof_verification_signal_contract.sql',
  },
  {
    name: PROOF_MEDIA_METADATA_MINIMIZATION_MIGRATION,
    fileName: '20260720_proof_media_metadata_minimization.sql',
  },
  {
    name: MEDIA_UPLOAD_FINALIZATION_CONTRACT_MIGRATION,
    fileName: '20260720_media_upload_finalization_contract.sql',
  },
  {
    name: PRIVATE_MEDIA_DELIVERY_CONTRACT_MIGRATION,
    fileName: '20260720_private_media_delivery_contract.sql',
  },
  {
    name: WORKER_STANDING_APPEALS_MIGRATION,
    fileName: '20260720_worker_standing_appeals.sql',
  },
  {
    name: OFFLINE_ACTION_RECONCILIATION_MIGRATION,
    fileName: '20260720_offline_action_reconciliation.sql',
  },
  {
    name: DISPUTE_RELEASE_AUTHORITY_CONTRACT_MIGRATION,
    fileName: '20260720_dispute_release_authority_contract.sql',
  },
  {
    name: NOTIFICATION_DELIVERY_CONTRACT_MIGRATION,
    fileName: '20260720_notification_delivery_contract.sql',
  },
  {
    name: NOTIFICATION_DELIVERY_CONTRACT_REPAIR_MIGRATION,
    fileName: '20260720_notification_delivery_contract_repair.sql',
  },
  {
    name: NOTIFICATION_FOCUS_SUPPRESSION_MIGRATION,
    fileName: '20260720_notification_focus_suppression.sql',
  },
  {
    name: SCHEMA_CONVERGENCE_REPAIR_MIGRATION,
    fileName: '20260720_schema_convergence_repair.sql',
  },
  {
    name: LOCAL_CERTIFICATION_PAYMENT_PROVIDER_MIGRATION,
    fileName: '20260720_local_certification_payment_provider.sql',
  },
  {
    name: REGION_POLICY_PRICE_BOOK_ALIGNMENT_MIGRATION,
    fileName: '20260720_region_policy_price_book_alignment.sql',
  },
  {
    name: LOCAL_CERTIFICATION_PAYOUT_PROVIDER_MIGRATION,
    fileName: '20260720_local_certification_payout_provider.sql',
  },
  {
    name: LOCAL_CERTIFICATION_SCREENING_PROVIDER_MIGRATION,
    fileName: '20260720_local_certification_screening_provider.sql',
  },
  {
    name: CONTROLLED_TEST_LIQUIDITY_CELL_MIGRATION,
    fileName: '20260720_controlled_test_liquidity_cell.sql',
  },
  {
    name: CONTROLLED_TEST_LIQUIDITY_MARKER_REPAIR_MIGRATION,
    fileName: '20260720_controlled_test_liquidity_marker_repair.sql',
  },
  {
    name: CONTROLLED_TEST_LIQUIDITY_LIFECYCLE_REPAIR_MIGRATION,
    fileName: '20260720_controlled_test_liquidity_lifecycle_repair.sql',
  },
  {
    name: CONTROLLED_TEST_DURATION_EVIDENCE_MIGRATION,
    fileName: '20260720_controlled_test_duration_evidence.sql',
  },
  {
    name: CONTROLLED_TEST_PROVIDER_CAPABILITY_MIGRATION,
    fileName: '20260720_controlled_test_provider_capability.sql',
  },
  {
    name: CONTROLLED_TEST_PROVIDER_CAPABILITY_EXPIRY_MIGRATION,
    fileName: '20260720_controlled_test_provider_capability_expiry.sql',
  },
  {
    name: CONTROLLED_TEST_PROVIDER_CAPABILITY_REFRESH_MIGRATION,
    fileName: '20260720_controlled_test_provider_capability_refresh.sql',
  },
  {
    name: CONTROLLED_TEST_PROVIDER_CAPABILITY_REFRESH_REPAIR_MIGRATION,
    fileName: '20260720_controlled_test_provider_capability_refresh_repair.sql',
  },
  {
    name: CONTROLLED_TEST_OFFER_REVIEW_MIGRATION,
    fileName: '20260720_controlled_test_offer_review.sql',
  },
  {
    name: TASK_SAFETY_STATE_INTEGRITY_MIGRATION,
    fileName: '20260720_task_safety_state_integrity.sql',
  },
  {
    name: TASK_SAFETY_RESOLUTION_INTEGRITY_MIGRATION,
    fileName: '20260720_task_safety_resolution_integrity.sql',
  },
  {
    name: TASK_SAFETY_CASE_ACCESS_INTEGRITY_MIGRATION,
    fileName: '20260720_task_safety_case_access_integrity.sql',
  },
  {
    name: OPERATIONS_EXCEPTION_CONTRACT_MIGRATION,
    fileName: '20260720_operations_exception_contract.sql',
  },
  {
    name: HUSTLER_TRUST_PROGRESSION_CONTRACT_MIGRATION,
    fileName: '20260721_hustler_trust_progression_contract.sql',
  },
  {
    name: TASK_QUOTE_SHORTLIST_MESSAGING_CONTRACT_MIGRATION,
    fileName: '20260721_task_quote_shortlist_messaging_contract.sql',
  },
  {
    name: UNIT_ECONOMICS_GUARDRAILS_MIGRATION,
    fileName: '20260721_unit_economics_guardrails.sql',
  },
  {
    name: BUILD_NOW_SPEND_PROMOTION_GUARDRAILS_MIGRATION,
    fileName: '20260721_build_now_spend_promotion_guardrails.sql',
  },
  {
    name: PRIVATE_IDENTITY_VERIFICATION_CONTRACT_MIGRATION,
    fileName: '20260721_private_identity_verification_contract.sql',
  },
  {
    name: SENSITIVE_MEDIA_INGESTION_SHUTDOWN_MIGRATION,
    fileName: '20260721_sensitive_media_ingestion_shutdown.sql',
  },
  {
    name: AI_OBSERVABILITY_CONTRACT_MIGRATION,
    fileName: '20260721_ai_observability_contract.sql',
  },
  {
    name: CONTROLLED_TEST_RETAKE_ACCEPTANCE_REPAIR_MIGRATION,
    fileName: '20260721_controlled_test_retake_acceptance_repair.sql',
  },
  {
    name: CONTROLLED_TEST_RETAKE_LIQUIDITY_REPAIR_MIGRATION,
    fileName: '20260721_controlled_test_retake_liquidity_repair.sql',
  },
  {
    name: CONTROLLED_TEST_RETAKE_GUARD_CONVERGENCE_MIGRATION,
