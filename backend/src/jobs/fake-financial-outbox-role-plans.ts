import { WORKER_CHANGE_ORDER_ADJUSTMENT_PREPARATION, WORKER_CHANGE_ORDER_ADJUSTMENT_INTERNAL_FUNCTIONS, WORKER_CHANGE_ORDER_ADJUSTMENT_PREPARATIONS } from './change-order-adjustment-role-plans.js';
import {
...
export const FAKE_FINANCIAL_OUTBOX_WORKER_FUNCTIONS = [
  WORKER_CHANGE_ORDER_ADJUSTMENT_PREPARATION,
  ...CHANGE_ORDER_TERMINAL_FUNCTIONS,
  CHANGE_ORDER_REVERSAL_PREPARATION_FUNCTION,
  CHANGE_ORDER_RECOVERY_COMPENSATION_FUNCTION,
  CHANGE_ORDER_RECOVERY_CLAIM_FUNCTION,
...
export const FAKE_FINANCIAL_OUTBOX_DEFINER_FUNCTIONS = [
  ...WORKER_CHANGE_ORDER_ADJUSTMENT_INTERNAL_FUNCTIONS,
  CHANGE_ORDER_TERMINAL_INTERNAL_FUNCTION,
  ...CHANGE_ORDER_REVERSAL_INTERNAL_FUNCTIONS,
...
export const FAKE_FINANCIAL_OUTBOX_RELATIONS = [
  WORKER_CHANGE_ORDER_ADJUSTMENT_PREPARATIONS,
  CHANGE_ORDER_REVERSAL_PREPARATIONS,
  CHANGE_ORDER_RECOVERY_COMPENSATION_ORIGINS,
