    ...
    .query(async ({ ctx, input }) => {
      ...
      const result = await db.query(
        `SELECT sta.*,
           ...
           t.payment_cents as t_payment_cents, t.location as t_location,
           t.category as t_category, t.estimated_duration as t_estimated_duration,
           t.urgency as t_urgency, t.state as t_state,
      ...
      return result.rows.map(r => ({
        ...
        task: {
          ...
          payment: r.t_payment_cents / 100,
          location: r.t_location,
          category: r.t_category,
          estimatedDuration: r.t_estimated_duration,
          urgency: r.t_urgency,
          state: r.t_state,
