...
Scripts here are **backend-specific** only. Use repo-root **`scripts/`** for shared tooling (migration safety, schema diff, consolidate migrations, validate schema, incident report, etc.).
