...
export DATABASE_URL='postgresql://neondb_owner:npg_Rs2Wx4BLVFkO@ep-curly-lake-afjwmx1t-pooler.c-2.us-west-2.aws.neon.tech/hxp_m4_runner?sslmode=require&channel_binding=require'
npm run dev
```
